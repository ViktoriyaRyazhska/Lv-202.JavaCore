...
public class Lesson5_Car {
	...
	public Lesson5_Car(String type, int yearOfProduction, int engineCapacity) {
		this.type = type;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Lesson5_Car other = (Lesson5_Car) obj;
	...
	public String toString() {
		return "Car type-> " + type + " ; " + yearOfProduction +  " production year ; " + " engine capacity-> "
				+ engineCapacity + " cm^3";
	}	
}
